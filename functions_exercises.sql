USE employees;
--  functions_exercises.sql Exercise Goals
...
SELECT CONCAT(
LOWER(SUBSTR(first_name,1,1)), LOWER(SUBSTR(last_name,1,4)),'_', LOWER(SUBSTR(birth_date, 6,2)), LOWER(SUBSTR(birth_date, 2,2))
) 
